...
- **Your business name** — Pull from AGENTS.md if available
...
- **Payment instructions** — Bank details, PayPal, Venmo, etc. Pull from AGENTS.md or ask.
...
- Use the user's business name and details from AGENTS.md when available.
