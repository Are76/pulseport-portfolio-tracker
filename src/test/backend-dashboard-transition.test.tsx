      ...
      <BackendDashboardTransitionPanel
        ...
        backendDashboardResponse={{
          ...
          data: {
            ...
            chainId: 369,
            balances: [{ assetId: 'native-pls', symbol: 'PLS', quantity: '123.45', pricingStatus: 'available', valuationStatus: 'available', priceUsd: 0.00005, valueUsd: 12.34 }],
      ...
      <BackendDashboardTransitionPanel
        ...
        backendDashboardResponse={{
          ...
          data: {
            ...
            walletAddress: wallets[0].address,
            chainId: 369,
            balances: [{ assetId: 'native-pls', symbol: 'PLS', quantity: '999', pricingStatus: 'available', valuationStatus: 'available', priceUsd: 0.00005, valueUsd: 99 }],
            warnings: [],
