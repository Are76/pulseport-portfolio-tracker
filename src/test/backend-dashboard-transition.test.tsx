      ...
      <BackendDashboardTransitionPanel
        ...
        backendDashboardResponse={{
          ...
          data: {
            ...
            chainId: 369,
            balances: [{ assetId: 'native:369:pls', chainId: 369, address: 'native', symbol: 'PLS', name: 'PulseChain', quantity: '123.45', pricingStatus: 'available', valuationStatus: 'available', priceUsd: 0.00005, valueUsd: 12.34 }],
      ...
      <BackendDashboardTransitionPanel
        ...
        backendDashboardResponse={{
          ...
          data: {
            ...
            walletAddress: wallets[0].address,
            chainId: 369,
            balances: [{ assetId: 'native:369:pls', chainId: 369, address: 'native', symbol: 'PLS', name: 'PulseChain', quantity: '999', pricingStatus: 'available', valuationStatus: 'available', priceUsd: 0.00005, valueUsd: 99 }],
            warnings: [],
